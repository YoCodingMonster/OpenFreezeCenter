...
def change(lable):
	lable.config(fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey')
	return
...
lable_c1 = Label(window_m, text = "CPU Temperature (Celcius) : ", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(10, 1)))
lable_c1.place(x = scaled(10, 2), y = scaled(27, 2))
lable_c11 = Label(window_m, text = "", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(11, 1)))
lable_c11.place(x = scaled(190, 2), y = scaled(27, 2))

lable_c2 = Label(window_m, text = "Max", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(10, 1)))
lable_c2.place(x = scaled(245, 2), y = scaled(10, 2))
lable_c22 = Label(window_m, text = "", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(11, 1)))
lable_c22.place(x = scaled(250, 2), y = scaled(27, 2))

lable_c3 = Label(window_m, text = "Min", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(10, 1)))
lable_c3.place(x = scaled(285, 2), y = scaled(10, 2))
lable_c33 = Label(window_m, text = "", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(11, 1)))
lable_c33.place(x = scaled(290, 2), y = scaled(27, 2))

lable_g1 = Label(window_m, text = "GPU Temperature (Celcius) : ", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(10, 1)))
lable_g1.place(x = scaled(10, 2), y = scaled(47, 2))
lable_g11 = Label(window_m, text = "", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(11, 1)))
lable_g11.place(x = scaled(190, 2), y = scaled(47, 2))

lable_g22 = Label(window_m, text = "", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(11, 1)))
lable_g22.place(x = scaled(250, 2), y = scaled(47, 2))

lable_g33 = Label(window_m, text = "", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(11, 1)))
lable_g33.place(x = scaled(290, 2), y = scaled(47, 2))

lable_m4 = Label(window_m, text = "CPU fan RPM : ", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(10, 1)))
lable_m4.place(x = scaled(10, 2), y = scaled(67, 2))
lable_m44 = Label(window_m, text = "", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(11, 1)))
lable_m44.place(x = scaled(190, 2), y = scaled(67, 2))

lable_m5 = Label(window_m, text = "GPU fan RPM : ", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(10, 1)))
lable_m5.place(x = scaled(10, 2), y = scaled(87, 2))
lable_m55 = Label(window_m, text = "", fg = 'black' if mode == 0 else 'white', bg = 'black' if mode == 1 else 'light grey', font=("Helvetica", scaled(11, 1)))
